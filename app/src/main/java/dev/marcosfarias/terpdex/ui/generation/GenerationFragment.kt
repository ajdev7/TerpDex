package dev.marcosfarias.terpdex.ui.generation
...
import dev.marcosfarias.terpdex.model.Generation
...
class GenerationFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        generationViewModel.getListGeneration().observe(viewLifecycleOwner, Observer {
            val terpmons: List<Generation> = it
            recyclerView.adapter = GenerationAdapter(terpmons, view.context)
        })
    }
}
